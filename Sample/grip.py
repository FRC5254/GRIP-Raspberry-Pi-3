...
class GripPipeline:
    ...
    To use the pipeline first create a GripPipeline instance and set the sources,
    ...
    def __init__(self):
        ...
        self.__hsv_threshold_hue = [77.6978417266187, 126.24573378839591]
        self.__hsv_threshold_saturation = [158.22841726618702, 255.0]
        self.__hsv_threshold_value = [190.33273381294964, 255.0]
